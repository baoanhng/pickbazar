...
import BannerShort from "@components/banner/banner-short";
...
export default function FurnitureTwoPage() {
  ...
  return (
    <>
      ...
      <div className="flex flex-1 lg:pt-[80px] bg-gray-100">
        ...
        <main className="w-full xl:overflow-hidden block lg:mt-6">
          <BannerShort type="furniture-two" />
          <FilterBarLayoutTwo />
          <Element name="grid">
            <FeedLayoutTwo />
          </Element>
...
FurnitureTwoPage.Layout = HomeLayout;
