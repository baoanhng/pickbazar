...
Route::post('/send-otp-code', 'PickBazar\Http\Controllers\UserController@sendOtpCode');
Route::post('/verify-otp-code', 'PickBazar\Http\Controllers\UserController@verifyOtpCode');
Route::post('/otp-login', 'PickBazar\Http\Controllers\UserController@otpLogin');
...
Route::group(['middleware' => ['can:' . Permission::CUSTOMER, 'auth:sanctum']], function () {
    ...
    Route::post('/update-contact', 'PickBazar\Http\Controllers\UserController@updateContact');
