...
class AuthMutator
{
    ...
    {
        return Shop::call('PickBazar\Http\Controllers\UserController@sendOtpCode', $args);
    }
    public function verifyOtpCode($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('PickBazar\Http\Controllers\UserController@verifyOtpCode', $args);
    }
    public function otpLogin($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('PickBazar\Http\Controllers\UserController@otpLogin', $args);
    }
    public function updateContact($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('PickBazar\Http\Controllers\UserController@updateContact', $args);
    }
}
