...
use PickBazar\Otp\Gateways\OtpGateway;
...
class UserController extends CoreController
{
    ...
    protected function getOtpGateway()
    {
        ...
        $gateWayClass = "PickBazar\\Otp\\Gateways\\" . ucfirst($gateway) . 'Gateway';
    ...
    public function sendOtpCode(Request $request)
    {
        ...
        try {
            ...
            if (!$sendOtpCode->isValid()) {
                return ['message' => 'PICKBAZAR_ERROR.OTP_SEND_FAIL', 'success' => false];
            }
            $profile = Profile::where('contact', $phoneNumber)->first();
            return [
                'message' => 'PICKBAZAR_ERROR.OTP_SEND_SUCCESSFUL',
                'success' => true,
            ...
            throw new PickbazarException('PICKBAZAR_ERROR.INVALID_GATEWAY');
        }
    }
    ...
    public function verifyOtpCode(Request $request)
    {
        try {
            ...
            throw new PickbazarException('PICKBAZAR_ERROR.OTP_VERIFICATION_FAILED');
        } catch (\Throwable $e) {
            throw new PickbazarException('PICKBAZAR_ERROR.OTP_VERIFICATION_FAILED');
        }
    }
